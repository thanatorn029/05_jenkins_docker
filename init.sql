...
(4, 'Circuit de Spa-Francorchamps', 'Legendary Belgian track, known for Eau Rouge corner and unpredictable weather.', 'Circuit de Spa-Francorchamps.jpg', 50.4372, 5.9714),
...
(8, 'Interlagos (Autodromo Jose Carlos Pace)', 'Brazilian F1 circuit in São Paulo, famous for its passionate fans and unpredictable races.', 'Interlagos (Autodromo Jose Carlos Pace).avif', -23.7036, -46.6997),
...
(12, 'Nürburgring GP-Strecke', 'Modern GP track in Germany, part of famous Nürburgring complex.', 'Nrburgring GP-Strecke.avif', 50.3356, 6.9475);
